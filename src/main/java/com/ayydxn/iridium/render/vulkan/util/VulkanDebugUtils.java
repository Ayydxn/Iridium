package com.ayydxn.iridium.render.vulkan.util;

import com.ayydxn.iridium.render.vulkan.exceptions.VulkanOperationException;
...
{
    public static int createDebugUtilsMessenger(VkInstance instance, VkDebugUtilsMessengerCreateInfoEXT debugMessengerCreateInfo,
    ...
    public static void destroyDebugUtilsMessenger(VkInstance instance, long debugMessenger, VkAllocationCallbacks allocationCallbacks)
    {
    ...
    public static void vkCheckResult(int expression)
    {
        if (expression != VK_SUCCESS)
            throw new VulkanOperationException("A (presumably) Vulkan related expression failed!", expression);
    }
